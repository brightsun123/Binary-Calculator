...
class UltraSuperCalculator:
  ...
  def store_value_to_register(self, value_to_store):
    ...
    print(f"{int(value_to_store, 2)} was stored in Register: {self.numbers_index}.")
    self.numbers_index += 1
  ...
  def get_last_calculation(self):
    ...
    last_value = "The last calculated value was: " + str(self.history_registers[self.temp_history_index])
